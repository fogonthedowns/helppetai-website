...
# ============================================================================
# VET AVAILABILITY ENDPOINTS - DEPRECATED 
# ============================================================================
# 
# These endpoints have been deprecated in favor of the Unix timestamp-based
# scheduling system at /api/v1/scheduling-unix/vet-availability
# 
# Reason for deprecation:
# - The old system uses separate date + time columns which causes timezone boundary issues
# - The new system uses full UTC timestamps which properly handles all timezone scenarios
# - All production phone systems now use the Unix timestamp version
# 
...
async def get_vet_availability(
    ...
    """
    🚨 DEPRECATED ENDPOINT 🚨
    This endpoint has been deprecated due to timezone boundary handling issues.
    Please use /api/v1/scheduling-unix/vet-availability instead.
    """
    raise HTTPException(
        status_code=418,  # I'm a teapot
        detail={
            "error": "Endpoint deprecated",
            "message": "This vet-availability endpoint has been deprecated due to timezone boundary issues",
            "replacement": "/api/v1/scheduling-unix/vet-availability", 
            "reason": "The old date+time storage caused timezone boundary problems. Use Unix timestamps instead.",
            "migration_guide": "Replace calls to /scheduling/vet-availability with /scheduling-unix/vet-availability",
            "deprecated_on": "2025-09-24",
            "teapot": "☕ This endpoint is brewing up timezone troubles - use the Unix version instead!"
        }
    )

# ORIGINAL IMPLEMENTATION (COMMENTED FOR REFERENCE):
#
# async def get_vet_availability_ORIGINAL(
#     vet_user_id: uuid.UUID,
#     date: date = Query(..., description="Date to get availability for (LOCAL date in practice timezone)"),
#     timezone: str = Query("America/Los_Angeles", description="Practice timezone for date interpretation"),
#     include_inactive: bool = Query(False, description="Include inactive availability"),
...
async def create_vet_availability(
    ...
    raise HTTPException(
        ...
        detail={
            "error": "Endpoint deprecated",
            "message": "This vet-availability creation endpoint has been deprecated due to timezone boundary issues",
            "replacement": "POST /api/v1/scheduling-unix/vet-availability", 
            "reason": "The old date+time storage caused timezone boundary problems. Use Unix timestamps instead.",
            "migration_guide": "Replace calls to POST /scheduling/vet-availability with POST /scheduling-unix/vet-availability",
            "deprecated_on": "2025-09-24",
            "teapot": "☕ This endpoint is brewing up timezone troubles - use the Unix version instead!"
        }
    )
...
# async def create_vet_availability_ORIGINAL(
#     availability_data: VetAvailabilityCreate,
#     current_user: User = Depends(get_current_user),
#     repo: VetAvailabilityRepository = Depends(get_vet_availability_repository)
# ):
...
@router.put("/vet-availability/{availability_id}")
async def update_vet_availability(
    ...
    raise HTTPException(
        ...
        detail={
            "error": "Endpoint deprecated",
            "message": "This vet-availability update endpoint has been deprecated due to timezone boundary issues",
            "replacement": "PUT /api/v1/scheduling-unix/vet-availability/{availability_id}", 
            "reason": "The old date+time storage caused timezone boundary problems. Use Unix timestamps instead.",
            "migration_guide": "Replace calls to PUT /scheduling/vet-availability with PUT /scheduling-unix/vet-availability",
            "deprecated_on": "2025-09-24",
            "teapot": "☕ This endpoint is brewing up timezone troubles - use the Unix version instead!"
        }
    )
...
# async def update_vet_availability_ORIGINAL(
#     availability_id: uuid.UUID,
#     availability_data: VetAvailabilityUpdate,
#     current_user: User = Depends(get_current_user),
#     repo: VetAvailabilityRepository = Depends(get_vet_availability_repository)
...
@router.delete("/vet-availability/{availability_id}")
async def delete_vet_availability(
    ...
    raise HTTPException(
        ...
        detail={
            "error": "Endpoint deprecated",
            "message": "This vet-availability delete endpoint has been deprecated due to timezone boundary issues",
            "replacement": "DELETE /api/v1/scheduling-unix/vet-availability/{availability_id}", 
            "reason": "The old date+time storage caused timezone boundary problems. Use Unix timestamps instead.",
            "migration_guide": "Replace calls to DELETE /scheduling/vet-availability with DELETE /scheduling-unix/vet-availability",
            "deprecated_on": "2025-09-24",
            "teapot": "☕ This endpoint is brewing up timezone troubles - use the Unix version instead!"
        }
    )
...
# async def delete_vet_availability_ORIGINAL(
#     availability_id: uuid.UUID,
#     current_user: User = Depends(get_current_user),
#     repo: VetAvailabilityRepository = Depends(get_vet_availability_repository)
# ):
