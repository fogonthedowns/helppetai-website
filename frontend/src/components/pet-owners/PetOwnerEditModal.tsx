...
import PetOwnerEditForm from './PetOwnerEditForm';

interface PetOwnerEditModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSuccess?: () => void;
  ownerUuid: string;
...
const PetOwnerEditModal: React.FC<PetOwnerEditModalProps> = ({ isOpen, onClose, onSuccess, ownerUuid }) => {
...
export default PetOwnerEditModal;
