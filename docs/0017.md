...
Tell your backend team: "Keep your WebM expertise, but add server-side conversion to make it work with iOS."

# Backend converts everything to M4A using FFmpeg
# Both platforms can play M4A files
# Single source of truth for audio storage